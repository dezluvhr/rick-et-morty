...
bot.on('message', message => {
	...
	if (message.author === bot.user){
        ...
        if (message.content.startsWith(prefix + 'help')){
            ...
            .setFooter('Selfbot by 3laced', 'https://cdn.discordapp.com/attachments/627432311704649739/631924472915558401/BigAromaticEthiopianwolf-max-1mb.gif');
...
.setFooter('Selfbot made By 3laced', 'https://cdn.discordapp.com/attachments/627432311704649739/631924472915558401/BigAromaticEthiopianwolf-max-1mb.gif');
...
//}
		...
		if (message.content.startsWith(prefix + 'stream')){
             ...
             name: `${args.join(" ")}`,
             type: "STREAMING",
             url: "https://www.twitch.tv/lacedW"
             }
             });
...
message.delete()
bot.user.setStatus('idle', '3laced') 
...
message.delete()
bot.user.setStatus('invisible', '3laced') 
...
if(message.content === prefix + "multistream"){
    ...
    setInterval(function() {
        if(rotate === 0) {
            client.user.setActivity("rick", {type: "Streaming", url: 'https://www.twitch.tv/lacedW'});
            rotate = 1;       
        } else if(rotate === 1){
            client.user.setActivity("et", {type: "Streaming", url: 'https://www.twitch.tv/lacedW'});
            rotate = 2;
        } else if(rotate === 2){
            client.user.setActivity(`morty`, {type: "Streaming", url: 'https://www.twitch.tv/lacedW'});
            rotate = 3;
        }  else if(rotate === 3){
            random = Math.floor(Math.random() * 7) + 1;
            client.user.setActivity(`selfbot 👁️`, {type: "Streaming", url: 'https://www.twitch.tv/lacedW'});
            rotate = 0;
        }}, 20 * 2000)
...
message.delete()
bot.user.setStatus('online', '3laced') 
